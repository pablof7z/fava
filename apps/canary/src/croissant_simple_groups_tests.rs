...
fn write_pair_manifest(root: &Path, index: usize, author: &Keys, relay_keys: &Keys) {
    ...
    fs::write(
        ...
        serde_json::to_vec_pretty(&json!({
            ...
            "fava_canary_executable_sha256": FIXTURE_FAVA_EXECUTABLE,
            "fava_canary_subject_image_sha256": FIXTURE_FAVA_SUBJECT_IMAGE,
            "source_file_count": 1,
            ...
            "source_transport_image_sha256": crate::pinned_build_input::REGISTRY_IMAGE_SHA256,
        }))
    ...
    let mut manifest = json!({
        ...
        "fava_build_target_storage": "engine-content-addressed-image",
        "fava_build_target_maximum_bytes": 4_294_967_296_u64,
        "fava_build_subject_digest_origin": "engine-image",
        "fava_canary_subject_image_sha256": FIXTURE_FAVA_SUBJECT_IMAGE,
        "fava_build_source_transport": "owned-loopback-registry",
        "fava_build_source_transport_image_sha256": crate::pinned_build_input::REGISTRY_IMAGE_SHA256,
        "fava_build_source_immutable": true,
        "fava_source_clean": true,
        "fava_canary_executable_sha256": FIXTURE_FAVA_EXECUTABLE,
        "fava_canary_executable_bytes": 27,
