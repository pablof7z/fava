Feature: Semantic replaceable-event writes
  ...
  # fava:rust=fava/semantic_writes#source_v2_rematerialization_preserves_unrelated_fields
  ...
  # fava:rust=fava/semantic_write_publication#retired_completion_is_attributable_and_inert
  ...
  # fava:rust=external-semantic-capability/public_capability#external_capability_composes_through_public_fava
  ...
  # fava:rust=external-semantic-capability/public_capability#raw_future_event_kind_publishes_unchanged
