...
- [x] 4.7 Add bounded owner-side current-account synchronization after the experiential app proves `Observation::changed` can expose unread prior-generation evidence; verify app code performs no author or generation filtering, independently review, and merge the focused correction.
