...
| --- | --- | --- |
| Module | `fava_bookmarks` |  |
| Function | `fava_bookmarks::bookmark_coordinate` |  |
| Function | `fava_bookmarks::bookmark_event` |  |
| Function | `fava_bookmarks::materializer` |  |
| Function | `fava_bookmarks::unbookmark_coordinate` |  |
| Function | `fava_bookmarks::unbookmark_event` |  |
