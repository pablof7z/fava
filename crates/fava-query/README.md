...
| **`event`**<br><sub>Method</sub><!-- api-item {"kind":"Method","item":"fava_query::EventRecord::event","signature":"pub const fn fava_query::EventRecord::event(&self) -> &fava_write::EventValue","evidence":"cargo-public-api@0.52.0: pub const fn fava_query::EventRecord::event(&self) -> &fava_write::EventValue"} --> | Compiler-visible method owned by `fava_query::EventRecord`. |
...
| **`new`**<br><sub>Method</sub><!-- api-item {"kind":"Method","item":"fava_query::EventRecord::new","signature":"pub fn fava_query::EventRecord::new(fava_write::EventValue, fava_state::RelayOccurrences, core::option::Option<fava_write::receipt::PublicationEvidence>) -> core::result::Result<Self, fava_query::QueryEvaluationError>","evidence":"cargo-public-api@0.52.0: pub fn fava_query::EventRecord::new(fava_write::EventValue, fava_state::RelayOccurrences, core::option::Option<fava_write::receipt::PublicationEvidence>) -> core::result::Result<Self, fava_query::QueryEvaluationError>"} --> | Compiler-visible method owned by `fava_query::EventRecord`. |
| **`publication`**<br><sub>Method</sub><!-- api-item {"kind":"Method","item":"fava_query::EventRecord::publication","signature":"pub const fn fava_query::EventRecord::publication(&self) -> core::option::Option<&fava_write::receipt::PublicationEvidence>","evidence":"cargo-public-api@0.52.0: pub const fn fava_query::EventRecord::publication(&self) -> core::option::Option<&fava_write::receipt::PublicationEvidence>"} --> | Compiler-visible method owned by `fava_query::EventRecord`. |
| **`relay_occurrences`**<br><sub>Method</sub><!-- api-item {"kind":"Method","item":"fava_query::EventRecord::relay_occurrences","signature":"pub const fn fava_query::EventRecord::relay_occurrences(&self) -> &fava_state::RelayOccurrences","evidence":"cargo-public-api@0.52.0: pub const fn fava_query::EventRecord::relay_occurrences(&self) -> &fava_state::RelayOccurrences"} --> | Compiler-visible method owned by `fava_query::EventRecord`. |
...
<!-- api-item {"kind":"Struct","item":"fava_query::OperationGeneration","signature":"pub struct fava_query::OperationGeneration","evidence":"cargo-public-api@0.52.0: pub struct fava_query::OperationGeneration"} -->

| Item | Purpose |
| --- | --- |
| **`authority`**<br><sub>Method</sub><!-- api-item {"kind":"Method","item":"fava_query::OperationGeneration::authority","signature":"pub const fn fava_query::OperationGeneration::authority(self) -> core::num::nonzero::NonZeroU64","evidence":"cargo-public-api@0.52.0: pub const fn fava_query::OperationGeneration::authority(self) -> core::num::nonzero::NonZeroU64"} --> | Compiler-visible method owned by `fava_query::OperationGeneration`. |
| **`core::fmt::Display::fmt`**<br><sub>Method</sub><!-- api-item {"kind":"Method","item":"<fava_query::OperationGeneration as core::fmt::Display>::fmt","signature":"pub fn fava_query::OperationGeneration::fmt(&self, &mut core::fmt::Formatter<'_>) -> core::fmt::Result","evidence":"cargo-public-api@0.52.0: pub fn fava_query::OperationGeneration::fmt(&self, &mut core::fmt::Formatter<'_>) -> core::fmt::Result"} --> | Compiler-visible method owned by `fava_query::OperationGeneration`. |
| **`sequence`**<br><sub>Method</sub><!-- api-item {"kind":"Method","item":"fava_query::OperationGeneration::sequence","signature":"pub const fn fava_query::OperationGeneration::sequence(self) -> core::num::nonzero::NonZeroU64","evidence":"cargo-public-api@0.52.0: pub const fn fava_query::OperationGeneration::sequence(self) -> core::num::nonzero::NonZeroU64"} --> | Compiler-visible method owned by `fava_query::OperationGeneration`. |

### `OperationGenerationExhausted` (Enum)

Compiler-visible enum `fava_query::OperationGenerationExhausted`.
<!-- api-item {"kind":"Enum","item":"fava_query::OperationGenerationExhausted","signature":"pub enum fava_query::OperationGenerationExhausted","evidence":"cargo-public-api@0.52.0: pub enum fava_query::OperationGenerationExhausted"} -->
...
| Item | Purpose |
| --- | --- |
| **`access`**<br><sub>Method</sub><!-- api-item {"kind":"Method","item":"fava_query::Query::access","signature":"pub const fn fava_query::Query::access(&self) -> &fava_relay::RelayAccess","evidence":"cargo-public-api@0.52.0: pub const fn fava_query::Query::access(&self) -> &fava_relay::RelayAccess"} --> | Compiler-visible method owned by `fava_query::Query`. |
...
| **`with_relay_access`**<br><sub>Method</sub><!-- api-item {"kind":"Method","item":"fava_query::Query::with_relay_access","signature":"pub fn fava_query::Query::with_relay_access(self, fava_relay::RelayAccess) -> Self","evidence":"cargo-public-api@0.52.0: pub fn fava_query::Query::with_relay_access(self, fava_relay::RelayAccess) -> Self"} --> | Compiler-visible method owned by `fava_query::Query`. |
...
| **`RelayOccurrenceEventMismatch`**<br><sub>Enum variant</sub><!-- api-item {"kind":"Enum variant","item":"fava_query::QueryEvaluationError::RelayOccurrenceEventMismatch","signature":"pub fava_query::QueryEvaluationError::RelayOccurrenceEventMismatch","evidence":"cargo-public-api@0.52.0: pub fava_query::QueryEvaluationError::RelayOccurrenceEventMismatch"} --> | Compiler-visible enum variant owned by `fava_query::QueryEvaluationError`. |
| **`Field `event` of `RelayOccurrenceEventMismatch``**<br><sub>Public field</sub><!-- api-item {"kind":"Public field","item":"fava_query::QueryEvaluationError::RelayOccurrenceEventMismatch::event","signature":"pub fava_query::QueryEvaluationError::RelayOccurrenceEventMismatch::event: nostr::event::id::EventId","evidence":"cargo-public-api@0.52.0: pub fava_query::QueryEvaluationError::RelayOccurrenceEventMismatch::event: nostr::event::id::EventId"} --> | Compiler-visible public field owned by `fava_query::QueryEvaluationError`. |
| **`Field `occurrences` of `RelayOccurrenceEventMismatch``**<br><sub>Public field</sub><!-- api-item {"kind":"Public field","item":"fava_query::QueryEvaluationError::RelayOccurrenceEventMismatch::occurrences","signature":"pub fava_query::QueryEvaluationError::RelayOccurrenceEventMismatch::occurrences: nostr::event::id::EventId","evidence":"cargo-public-api@0.52.0: pub fava_query::QueryEvaluationError::RelayOccurrenceEventMismatch::occurrences: nostr::event::id::EventId"} --> | Compiler-visible public field owned by `fava_query::QueryEvaluationError`. |
...
| **`relay`**<br><sub>Method</sub><!-- api-item {"kind":"Method","item":"fava_query::QueryEvidence::relay","signature":"pub fn fava_query::QueryEvidence::relay(&self, &fava_relay::RelaySessionKey) -> core::option::Option<&fava_query::RelayQueryEvidence>","evidence":"cargo-public-api@0.52.0: pub fn fava_query::QueryEvidence::relay(&self, &fava_relay::RelaySessionKey) -> core::option::Option<&fava_query::RelayQueryEvidence>"} --> | Compiler-visible method owned by `fava_query::QueryEvidence`. |
...
| **`LiveRetentionLimit`**<br><sub>Enum variant</sub><!-- api-item {"kind":"Enum variant","item":"fava_query::QueryShortfall::LiveRetentionLimit","signature":"pub fava_query::QueryShortfall::LiveRetentionLimit","evidence":"cargo-public-api@0.52.0: pub fava_query::QueryShortfall::LiveRetentionLimit"} --> | Compiler-visible enum variant owned by `fava_query::QueryShortfall`. |
| **`Field `limit` of `LiveRetentionLimit``**<br><sub>Public field</sub><!-- api-item {"kind":"Public field","item":"fava_query::QueryShortfall::LiveRetentionLimit::limit","signature":"pub fava_query::QueryShortfall::LiveRetentionLimit::limit: core::num::nonzero::NonZeroUsize","evidence":"cargo-public-api@0.52.0: pub fava_query::QueryShortfall::LiveRetentionLimit::limit: core::num::nonzero::NonZeroUsize"} --> | Compiler-visible public field owned by `fava_query::QueryShortfall`. |
| **`Field `refused` of `LiveRetentionLimit``**<br><sub>Public field</sub><!-- api-item {"kind":"Public field","item":"fava_query::QueryShortfall::LiveRetentionLimit::refused","signature":"pub fava_query::QueryShortfall::LiveRetentionLimit::refused: u64","evidence":"cargo-public-api@0.52.0: pub fava_query::QueryShortfall::LiveRetentionLimit::refused: u64"} --> | Compiler-visible public field owned by `fava_query::QueryShortfall`. |
| **`Field `session` of `LiveRetentionLimit``**<br><sub>Public field</sub><!-- api-item {"kind":"Public field","item":"fava_query::QueryShortfall::LiveRetentionLimit::session","signature":"pub fava_query::QueryShortfall::LiveRetentionLimit::session: fava_relay::RelaySessionKey","evidence":"cargo-public-api@0.52.0: pub fava_query::QueryShortfall::LiveRetentionLimit::session: fava_relay::RelaySessionKey"} --> | Compiler-visible public field owned by `fava_query::QueryShortfall`. |
...
| **`generation`**<br><sub>Public field</sub><!-- api-item {"kind":"Public field","item":"fava_query::RelayQueryEvidence::generation","signature":"pub fava_query::RelayQueryEvidence::generation: core::option::Option<fava_query::OperationGeneration>","evidence":"cargo-public-api@0.52.0: pub fava_query::RelayQueryEvidence::generation: core::option::Option<fava_query::OperationGeneration>"} --> | Compiler-visible public field owned by `fava_query::RelayQueryEvidence`. |
...
| **`OwnerRefused`**<br><sub>Enum variant</sub><!-- api-item {"kind":"Enum variant","item":"fava_query::RelaySourceState::OwnerRefused","signature":"pub fava_query::RelaySourceState::OwnerRefused","evidence":"cargo-public-api@0.52.0: pub fava_query::RelaySourceState::OwnerRefused"} --> | Compiler-visible enum variant owned by `fava_query::RelaySourceState`. |
| **`Field `detail` of `OwnerRefused``**<br><sub>Public field</sub><!-- api-item {"kind":"Public field","item":"fava_query::RelaySourceState::OwnerRefused::detail","signature":"pub fava_query::RelaySourceState::OwnerRefused::detail: fava_query::BoundedText","evidence":"cargo-public-api@0.52.0: pub fava_query::RelaySourceState::OwnerRefused::detail: fava_query::BoundedText"} --> | Compiler-visible public field owned by `fava_query::RelaySourceState`. |
...
| **`Relay`**<br><sub>Enum variant</sub><!-- api-item {"kind":"Enum variant","item":"fava_query::SourceEvent::Relay","signature":"pub fava_query::SourceEvent::Relay(fava_state::RelayEvent)","evidence":"cargo-public-api@0.52.0: pub fava_query::SourceEvent::Relay(fava_state::RelayEvent)"} --> | Compiler-visible enum variant owned by `fava_query::SourceEvent`. |
| **`Field `0` of `Relay``**<br><sub>Public field</sub><!-- api-item {"kind":"Public field","item":"fava_query::SourceEvent::Relay::0","signature":"fava_state::RelayEvent","evidence":"cargo-public-api@0.52.0: fava_state::RelayEvent"} --> | Compiler-visible public field owned by `fava_query::SourceEvent`. |
