...
| **`settled`**<br><sub>Method</sub><!-- api-item {"kind":"Method","item":"fava_routing::RoutePlan::settled","signature":"pub fn fava_routing::RoutePlan::settled(&self) -> bool","evidence":"cargo-public-api@0.52.0: pub fn fava_routing::RoutePlan::settled(&self) -> bool"} --> | Compiler-visible method owned by `fava_routing::RoutePlan`. |
