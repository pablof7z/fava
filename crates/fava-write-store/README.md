...
| Method | `fava_write_store::WriteStore::accept_applied` |  |
| Method | `fava_write_store::WriteStore::accept_applied_edit` |  |
| Method | `fava_write_store::WriteStore::accept_reserved_applied_edit` |  |
| Method | `fava_write_store::WriteStore::active_capacity` |  |
| Method | `fava_write_store::WriteStore::applied_edits` |  |
...
| Method | `fava_write_store::WriteStore::install_revision` |  |
...
| Method | `fava_write_store::WriteStore::record_revision_failure` |  |
| Method | `fava_write_store::WriteStore::record_signer_refusal` |  |
| Method | `fava_write_store::WriteStore::record_signer_retryable` |  |
| Method | `fava_write_store::WriteStore::recover_applied_edits` |  |
...
| Function | `fava_write_store::validate_current_revision` |  |
