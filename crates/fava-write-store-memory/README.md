...
| Method | `<fava_write_store_memory::MemoryWriteStore as fava_write_store::WriteStore>::accept_materialized_edit` |  |
| Method | `<fava_write_store_memory::MemoryWriteStore as fava_write_store::WriteStore>::accept_reserved_materialized_edit` |  |
...
| Method | `<fava_write_store_memory::MemoryWriteStore as fava_write_store::WriteStore>::install_materialization` |  |
...
| Method | `<fava_write_store_memory::MemoryWriteStore as fava_write_store::WriteStore>::materialized_edits` |  |
...
| Method | `<fava_write_store_memory::MemoryWriteStore as fava_write_store::WriteStore>::record_materialization_failure` |  |
...
| Method | `<fava_write_store_memory::MemoryWriteStore as fava_write_store::WriteStore>::recover_materialized_edits` |  |
